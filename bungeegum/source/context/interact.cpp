...
#define get_interaction_impl(interaction_name)                                                                                                       \
    ...
    {                                                                                                                                                \
        ...
        if (_index != _data.command_data.index())                                                                                                    \
            return std::nullopt;                                                                                                                     \
        detail::##interaction_name##_interaction_data _interaction_data = std::get<detail::interaction_name##_interaction_data>(_data.command_data); \
        interaction_name##_interaction _interaction;                                                                                                 \
        _interaction._data = _interaction_data;                                                                                                      \
